/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0c4ff3062ee4243a6d81a1920829c6ff)
// Runtime types generated with workerd@1.20260205.0 2025-12-11 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RepoAgent" | "Sandbox";
	}
	interface Env {
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEFAULT_MODEL" | "ALLOWED_ORGS">> {}
}
declare module "*.hbs" {
	const value: string;
